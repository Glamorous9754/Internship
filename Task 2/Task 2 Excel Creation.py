...
combined_file = "final_combined_file.xlsx"
combined_df.to_excel(combined_file, index=False, header=False)  # Exclude header in the saved file
print(f"Final combined Excel saved as {combined_file}")
